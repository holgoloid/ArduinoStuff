  ...
  public class MqttHandler {
    ...
    public void Initialize() {
      ...
      client.MqttMsgPublishReceived += (o, e) => {
        ...
        Console.WriteLine($"{e.Topic}: {message}");
    ...
    public void ReportStatus(string apiToken, bool isLogging) {
      var answer = JsonConvert.SerializeObject(new MqttResponse { isLogging = isLogging });
